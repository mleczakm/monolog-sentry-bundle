    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ...
                ->end()
                ->scalarNode('monolog_sentry_handler')
                    ->info('ID of Monolog Sentry handler, default "monolog.handler.name_of_your_sentry_handler')
                    ->defaultValue('monolog.handler.sentry')
                ->end()
                ->scalarNode('cache')
